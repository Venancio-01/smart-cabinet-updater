...
layui.define(['form', 'element'], function (exports) {
    ...
    Class.prototype.render = function () {
        ...
        var elemFooter = [
            ...
            '<div class="cron-box"><div class="cron-footer-btns">' + (!!options.run ? '<span lay-type="run" class="cron-btns-run">运行</span>' : '') + '<span lay-type="confirm" class="cron-btns-confirm">确定</span><span lay-type="close" class="cron-btns-confirm">关闭</span></div></div>',
        ]; 
